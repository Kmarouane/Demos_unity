...
Solution:
	1-glissez-déposez le cube de couleur rouge dans l'armoire de gauche de façon à ce qu'il soit bien positionné, si tout se passe bien le domino n°1 sur l'écran verra sa couleur changer en rouge.
	2-glissez-déposez le cube N dans l'armoire de droite pour passer à l'itération suivant.
	3-recommencer l'étape 1 mais avec la couleur verte cette fois-ci.
	4-réitérez le procédé en suivant cet ordre : rouge-vert-bleu-rouge-vert-bleu.